      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {instructors.map((instructor, index) => (
            ...
            >
              <div className={`relative transition-all duration-500 transform-style-3d ${
                activeCard === index ? 'rotate-y-180' : ''
              }`}>
                {/* Card Front */}
                <div className={`bg-slate-800 border border-slate-700 rounded-xl overflow-hidden shadow-lg backface-hidden ${
                ...
                {/* Card Back */}
                <div className={`absolute inset-0 bg-slate-800 border border-slate-700 rounded-xl p-6 backface-hidden rotate-y-180 ${
